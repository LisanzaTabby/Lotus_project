...
urlpatterns = [
    ...
    path('student_list/add_student/', views.add_student, name='add_student'),
    ...
    path('school_list/edit_school/<str:pk>/', views.edit_school, name='edit_school'),
    path('school_list/delete_school/<str:pk>/', views.delete_school, name='delete_school'),
